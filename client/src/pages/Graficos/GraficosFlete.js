...
export default function GraficosFlete() {
	const data = {
		labels: [
			'Enero',
			'Febrero',
					...
					<div className="container-fluid">
						<div className="row mb-2">
							<div className="col-sm-6">
								<h1 className="m-0 text-dark">Grafico Flete</h1>
							</div>
							...
							<div className="col-sm-6">
								<ol className="breadcrumb float-sm-right">
									...
									<li className="breadcrumb-item active">GraficoFlete</li>
								</ol>
							</div>
						</div>
					</div>
							...
							<div className="col-md-6">
								<div className="card card-primary">
									<div className="card-header">
										<h3 className="card-title">Fletes Por Mes</h3>
